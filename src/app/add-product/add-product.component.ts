...
export class AddProductComponent implements OnInit {
    ...
    saveProduct(): void {
        this.productService.saveProduct(this.form.value).pipe(take(1)).subscribe(product => {
            if (product) {
    ...
    updateProduct(): void {
        ...
        this.productService.updateProduct(newProduct).pipe(take(1)).subscribe(product => {
